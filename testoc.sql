...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 02 2023 г., 17:39
...
(1, 'Default', '', 1, '2023-02-02 17:11:46', '2023-02-02 17:11:46');
...
(1, 0, 0, 'j8cmdhlpj8qua7qbpbffa6bqhde6uvf0', 30, 0, '{\"226\":\"15\"}', 1, '2023-02-02 17:14:50');
...
(1, 'Рубль', 'RUB', '', ' р.', '2', 1.00000000, 1, '2023-02-02 17:32:44'),
...
--
-- Структура таблицы `oc_dweb_exporting`
--

CREATE TABLE `oc_dweb_exporting` (
  `id` int(10) NOT NULL,
  ...
  `custom_parser` text DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
(28, 'dashboard', 'chart'),
(29, 'module', 'jivosite'),
(30, 'dwebexporter', 'dwebexporter'),
(31, 'module', 'dwebexporter');
...
(378, 0, 'config', 'config_encryption', '', 0),
...
(367, 0, 'config', 'config_seo_url_type', 'seo_url', 0),
(366, 0, 'config', 'config_seo_url', '0', 0),
...
(355, 0, 'config', 'config_ftp_status', '0', 0),
(356, 0, 'config', 'config_mail_protocol', 'mail', 0),
(353, 0, 'config', 'config_ftp_password', '', 0),
(354, 0, 'config', 'config_ftp_root', '', 0),
(352, 0, 'config', 'config_ftp_username', '', 0),
...
(350, 0, 'config', 'config_ftp_hostname', 'testoc', 0),
...
(322, 0, 'config', 'config_customer_search', '0', 0),
(321, 0, 'config', 'config_customer_activity', '0', 0),
(320, 0, 'config', 'config_customer_online', '0', 0),
...
(302, 0, 'config', 'config_currency', 'RUB', 0),
(303, 0, 'config', 'config_currency_auto', '1', 0),
...
(299, 0, 'config', 'config_zone_id', '2785', 0),
(296, 0, 'config', 'config_fax', '', 0),
(297, 0, 'config', 'config_image', '', 0),
(298, 0, 'config', 'config_country_id', '176', 0),
...
(294, 0, 'config', 'config_email', 'admin@admin.com', 0),
...
(399, 0, 'dwebexporter', 'dwebexporter_status', '1', 0);
...
(1, 1, 'admin', 'b58b6e6f4da33989d6088f8852a5c98b142596c6', 'F9wP1aWn4', 'John', 'Doe', 'admin@admin.com', '', '', '127.0.0.1', 1, '2023-02-02 17:11:46');
...
--
-- Индексы таблицы `oc_dweb_exporting`
--
ALTER TABLE `oc_dweb_exporting`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `oc_dweb_exporting`
--
ALTER TABLE `oc_dweb_exporting`
